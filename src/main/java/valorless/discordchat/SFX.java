 ...
 *   <li>Integration with {@link valorless.discordchat.Sound} model</li>
...
public interface SFX {
	 ...
	 * {@link valorless.discordchat.Sound} instance and plays it to the player.
	 * </p>
	 * 
	 * @param sound  the sound model containing playback parameters
	 * @param player the player who should hear the sound
	 */
	public static void Play(valorless.discordchat.Sound sound, Player player) {
	 ...
	 * <p>
	 * Convenience method that extracts the key, volume, and pitch from a
	 * {@link valorless.discordchat.Sound} instance and plays it at the location.
	 * </p>
	 * 
	 * @param sound    the sound model containing playback parameters
	 * @param location the location where the sound should be played
	 */
	public static void Play(valorless.discordchat.Sound sound, Location location) {
	    Play(sound.key, sound.volume, sound.pitch, location);
	}
	
	/** Default sound identifier when block place sound cannot be determined. */
	static final String DEFAULT_PLACE = "BLOCK_STONE_PLACE";
	
	/** Default sound identifier when block break sound cannot be determined. */
    static final String DEFAULT_BREAK = "BLOCK_STONE_BREAK";
